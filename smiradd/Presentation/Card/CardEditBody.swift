    ...
    var body: some View {
                                ...
                                SaveButton(canSave: !jobTitle.isEmpty && !specificity.isEmpty && !firstName.isEmpty && !lastName.isEmpty && !email.isEmpty)
                                    .onTapGesture {
                                        let body: [String: String] = [
                                            ...
                                            "email": email,
                                            "bc_template_type": cardSettings.bcTemplateType
                                        ]
        ...
        .onAppear {
            if cardSettings.cardType == .editCard {
                ...
                phone = cardSettings.cardModel.phone ?? ""
                email = cardSettings.cardModel.email
                address = cardSettings.cardModel.address ?? ""
                telegram = cardSettings.cardModel.tg_url ?? ""
                vk = cardSettings.cardModel.vk_url ?? ""
                facebook = cardSettings.cardModel.fb_url ?? ""
