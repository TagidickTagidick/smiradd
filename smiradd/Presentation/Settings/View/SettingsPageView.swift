...
//                                        CameraPageView(selectedImage: self.$avatarUIImage)
...
//                                    }
                    ...
                    if !firstName.isEmpty || !lastName.isEmpty {
                        if self.viewModel.profileModel?.first_name != firstName || self.viewModel.profileModel?.last_name != lastName || (
                            !avatarUrl.isEmpty
                               || avatarImage != nil
                               || avatarUIImage != nil
                              ) {
            ...
            .background(.white)
            .onAppear {
                self.firstName = self.viewModel.profileModel?.first_name ?? ""
                self.lastName = self.viewModel.profileModel?.last_name ?? ""
                self.avatarUrl = self.viewModel.profileModel?.picture_url ?? ""
            }
            .onTapGesture {
