    ...
    var body: some View {
        ScrollView {
            VStack (alignment: .leading) {
                ...
                Spacer()
                    .frame(height: 12)
                ForEach(profileSettings.notificationsModel!.items) { notificationModel in
                    VStack (alignment: .leading) {
                        Spacer()
                            .frame(height: 17)
                        HStack {
        ...
        .background(.white)
        .onAppear {
            if profileSettings.notificationsModel != nil {
                for notificationModel in profileSettings.notificationsModel!.items {
